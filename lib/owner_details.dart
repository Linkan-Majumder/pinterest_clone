...
class OwnerDetails extends StatefulWidget {
  ...
  OwnerDetails({Key? key, required this.img, required this.userImg, required this.name, required this.date, required this.docId, required this.userId, required this.downloads}) : super(key: key);

        ...
        children: [
          ...
          RectangularButton(
            ...
            press: () async{
              ...
              try{
                final ref = FirebaseStorage.instance.ref().child('user Images').child(DateTime.now().toString() + '.jpg');
                ...
                'id': _uid,
'userImage': imageUrl,'name':_fullNameController.text,'email': _emailTextController.text, 'createAt': Timestamp.now(),
});

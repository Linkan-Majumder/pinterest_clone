...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _upload_image() async{
    ...
    try{
      final ref = FirebaseStorage.instance.ref().child('userImage').child(DateTime.now().toString() + 'jpg');
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 15,),
              Padding(padding: EdgeInsets.only(left: 8.0, right: 8.0, bottom: 8.0),
             child: Row(
               children: [
                 CircleAvatar(
                   radius: 30,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('wallpaper').orderBy("createdAt",
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index){
                    return gridViewWidget(
                      ...
                      snapshot.data!.docs[index].id,
                      snapshot.data!.docs[index]['Image'], // it is capital Image I
                      snapshot.data!.docs[index]['userImage'],
                      snapshot.data!.docs[index]['name'],
                      snapshot.data!.docs[index]['createdAt'].toDate(),
                      snapshot.data!.docs[index]['id'],
